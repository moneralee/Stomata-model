...
Stomata_model_Shao_Li_Yang_et_al.py can be run in a python environment. The standard python libraries 'numpy', 'scipy', 'os', 'matplotlib' are needed. Python installation in a normal computer takes between 5 and 15 minutes.
