...
Stomata_model_Shao_Li_Yang_et_al.py can be run in a python environment. The standard python libraries 'numpy', 'scipy', 'os', 'matplotlib' are needed. 
...
The simulations reported in the manuscript were performed in a Linux machine (Ubuntu 24.04), and have also been run on MacOS operating system (Ventura 13.5).
