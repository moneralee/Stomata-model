...
for param in range(param_analysis):
    ...
    Km1=np.random.uniform(40 * 0.95, 40 * 1.05)
    Km2=np.random.uniform(50 * 0.95, 50 * 1.05)
    Km3=np.random.uniform(75 * 0.95, 75 * 1.05)
    Km4=np.random.uniform(75 * 0.95, 75 * 1.05)
    Km5=np.random.uniform(40 * 0.95, 40 * 1.05) # update - ABA OST1-independent pathway
    KmAHA=np.random.uniform(50 * 0.95, 50 * 1.05)
    KmSLAC1P=np.random.uniform(50 * 0.95, 50 * 1.05) # update - slac1 now modelled with a un- and a -phosphorylated form.
    prod=np.random.uniform(0.01 * 0.95, 0.01 * 1.05)
    KmABA=np.random.uniform(25 * 0.95, 25 * 1.05)
    KmPP2C=np.random.uniform(50 * 0.95, 50 * 1.05)
    KmTOT3P2=np.random.uniform(50 * 0.95, 50 * 1.05)
    KmUBP24=np.random.uniform(50 * 0.95, 50 * 1.05)
...
ax.bar(x - width/2, Finalvalues[:, 0,param], width, label='21°', color='#ADD8E6')
ax.bar(x + width/2, Finalvalues[:, 1,param], width, label='42°', color='#A52A2A')
...
ax.set_ylim(0, 1)
plt.tight_layout()
plt.savefig('output/Wt-ost1-variants5.svg', dpi=300, bbox_inches='tight')
plt.savefig('output/Wt-ost1-variants5.png', dpi=200, bbox_inches='tight')
plt.show()
...
for i, data in enumerate(violin_data, start=1):
    ...
    ax.scatter(x_jitter, data, s=10, color='black', alpha=0.5, zorder=3)
ax.set_ylabel('Stomata aperture')
ax.set_title('Stomata aperture in response to temperature')
...
ax.set_ylim(0, 1)
plt.tight_layout()
plt.savefig('output/Wt-ost1-variants-violin5.svg', dpi=300, bbox_inches='tight')
plt.savefig('output/Wt-ost1-variants-violin5.png', dpi=200, bbox_inches='tight')
plt.show()
...
ax.set_ylim(0, 1)
plt.tight_layout()
plt.savefig('output/TemperaturexStomata-violin5.svg', dpi=300, bbox_inches='tight')
plt.savefig('output/TemperaturexStomata-violin5.png', dpi=200, bbox_inches='tight')
plt.show()
...
ax.set_ylim(0, 1)
plt.tight_layout()
plt.savefig('output/HxD-Finalvalues-violin5.svg', dpi=300, bbox_inches='tight')
plt.savefig('output/HxD-Finalvalues-violin5.png', dpi=200, bbox_inches='tight')
plt.show()
